<h2><a href="https://leetcode.com/problems/buy-two-chocolates/description/">939. Valid Permutations for DI Sequence</a></h2><h3>Hard</h3><hr><p>You are given a string <code>s</code> of length <code>n</code> where <code>s[i]</code> is either:</p>
